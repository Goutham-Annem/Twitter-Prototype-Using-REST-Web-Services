...
var SearchHandlePage = require('./routes/SearchHandlePage');
...
app.post('/successSignIn',login.successSignIn);
app.post('/afterSignUp',signUp.afterSignUp);
app.get('/homePageWhenLogin',homePageAfterLogin.homePageWhenLogin);
app.post('/logout',login.logout);
app.get('/userInfoPage',userInfo.userInfoPage);
...
app.get('/HashPageSuccess',hashPage.HashPageSuccess);
...
app.get('/SearchHandlePage',SearchHandlePage.SearchHandlePage);
app.post('/performFollow',tweet.performFollow);
app.post('/performRetweet',tweet.performRetweet);
app.post('/getList',userInfo.getList);
/*app.use('/', routes);
app.use('/users', users);*/
